<html>
<head>
<title>Goalkeeper Database</title>
...
<script src="js/advanced-goalkeeper.js"></script>
...
<div class="container-fluid mt-3 mb-3">
	...
	<div class="pb-3">
		<button type="button" id="addGoalkeeper" class="btn btn-primary btn-sm">Add Goalkeeper</button>
	</div> 
        	
	<div>
		<table id="table-goalkeeper" class="table table-bordered table-striped">
			<thead>
				<tr>
					<th>ID</th>
                    <th>Name</th>
...
<div id="goalkeeper-modal" class="modal fade">
	<div class="modal-dialog">
		<form method="post" id="goalkeeper-form">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Edit Goalkeeper</h4>
				</div>
				<div class="modal-body">
					<div class="form-group">
						...
						<label>Contract End Date</label> <input type="date" class="form-control" size="12" value="0" id="contractenddate">
                        ...
                        <label>Clean Sheets</label> <input type="number" class="form-control" min="0" step="1" size="3" value="0" id="cleansheets">
