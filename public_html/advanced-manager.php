...
<script src="js/advanced-manager.js"></script>
...
<div class="container-fluid mt-3 mb-3">
	...
	<div class="pb-3">
		<button type="button" id="addManager" class="btn btn-primary btn-sm">Add Manager</button>
	</div> 
        	
	<div>
		<table id="table-manager" class="table table-bordered table-striped">
			<thead>
				<tr>
					<th>ID</th>
					<th>Name</th>
