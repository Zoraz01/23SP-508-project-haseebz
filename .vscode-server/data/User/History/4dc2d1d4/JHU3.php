			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
                        ...
                        <label>Contract End Date</label> <input type="date" class="form-control" size="12" value="0" id="birthdate">
						...
						<label>Postion</label> <input type="text" class="form-control" id="appearances" placeholder="Enter Position" required>

						<label>Value</label> <input type="number" class="form-control" min="0.01" step="0.01" size="12" value="0" id="salary">
