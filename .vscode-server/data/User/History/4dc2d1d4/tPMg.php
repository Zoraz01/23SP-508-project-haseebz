...
<div class="container-fluid mt-3 mb-3">
	...
	<div class="pb-3">
		<button type="button" id="add Person" class="btn btn-primary btn-sm">Add Employee</button>
	</div> 
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<label>Nationality</label> <input type="text" class="form-control" id="email" placeholder="Enter Nationality" required>
