...
function updatePlayer()
{
    ...
    if ($_POST['ID']) {
        ...
        $sqlQuery = "UPDATE Player, Person
                        ...
                        Player.Value = :Value
                    WHERE Players.Person_id = Person.Person_ID AND Person_ID = :Person_ID";
        
        $stmt = $conn->prepare($sqlQuery);
        $stmt->bindValue(':Dirst_name', $_POST["firstname"]);
...
function addPlayer()
{
    ...
    $sqlQuery = "INSERT INTO Person
                 (First_name, Last_name, Nationality, Salary, , job_ID, salary, hire_date)
                 VALUES
