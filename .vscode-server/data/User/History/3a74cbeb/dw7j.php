...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
    ...
    try {
        $stmt = $conn->prepare("UPDATE Person SET First_name=:First_name, Last_name=:Last_name, Nationality=:Nationality, salary=:salary Date_of_birth = :Date_of_birth, Contract_end_dateWHERE employee_id=:employee_id");
